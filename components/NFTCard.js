...
<section class="card">
    <div class="nft-img-container">
        <img width="1" height="1" class="nft-img" src="/images/image-equilibrium.webp" alt="Equilibrium NFT image" loading="lazy">
    ...
    <section class="nft-creator">
        <div class="user-profile-img">
            <img width="1" height="1" src="/images/image-avatar.webp" alt="User profile picture" loading="lazy">
        </div>
        <p class="credits">Creation of <span class="user-name">Jules Wyvern</span></p>
    </section>
</section>
`;
